...
{ 
  public class DataAdapter : BaseAdapter<MClass>
  {
      private readonly Activity context;
      private readonly List<MClass> mItems;

      public DataAdapter(Activity context, List<MClass> items)
      {
          this.mItems = items;
      ...
      public override MClass this[int position]
      {
